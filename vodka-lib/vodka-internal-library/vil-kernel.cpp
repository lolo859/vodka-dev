...
bool vodka::library::kernel::CallTreatement::print_int(SourcesStack lclstack) {
    ...
    log("Checking system call syntax.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,1},{function_call.cell_context.content.size(),3});
    auto eles=split(line," ");
    if (eles.size()>=2) {
        log("Checking content existence and datatype.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,2},{function_call.cell_context.content.size(),3});
        ...
        log("Registering system call.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,3},{function_call.cell_context.content.size(),3});
...
bool vodka::library::kernel::CallTreatement::add_int(SourcesStack lclstack) {
    auto srclclstack=lclstack;
    srclclstack.add(__PRETTY_FUNCTION__,__FILE__);
    log("Checking system call syntax.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,1},{function_call.cell_context.content.size(),1});
    auto eles=split(line," ");
    if (eles.size()>=4) {
        log("Checking content existence and datatype.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,2},{function_call.cell_context.content.size(),2});
...
bool vodka::library::kernel::CallTreatement::invert_int(SourcesStack lclstack) {
    ...
    if (eles.size()==2) {
        ...
        log("Registering system call.",function_call.verbose_context,function_call.main_logstep_context,function_call.last_logstep_context,2,{(int)function_call.iteration_number_context+1,4},{function_call.cell_context.content.size(),3});
